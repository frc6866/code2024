...
public class AbsoluteDriveAdv extends Command
{
  ...
  private final SwerveTest2 swerve;
   ...
   */
  public AbsoluteDriveAdv(SwerveTest2 swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           Constants.Drive.LOOP_TIME, Constants.Drive.ROBOT_MASS, List.of(Constants.Drive.CHASSIS),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (Constants.Drive.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
