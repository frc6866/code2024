...
public class AutonNoNote extends SequentialCommandGroup {
    public AutonNoNote(Robot robot) {
        addCommands(
            new ParallelRaceGroup(new CommandDrive(robot, 0.3, 0.3), new WaitCommand(1)),
